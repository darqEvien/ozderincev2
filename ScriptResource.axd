...
Type.registerNamespace('Sys.WebForms');
Sys.WebForms.Res={
"PRM_MissingPanel":"ID değeri \u0027{0}\u0027 olan UpdatePanel bulunamadı. Dinamik olarak güncelleştiriliyorsa, başka bir UpdatePanel\u0027ın içinde olmalıdır.",
"PRM_ServerError":"Sunucuda istek işlenirken bilinmeyen bir hata oluştu. Sunucudan döndürülen durum kodu: {0}",
"PRM_ParserError":"Sunucudan alınan ileti ayrıştırılamadı.",
"PRM_TimeoutError":"Sunucu isteği zaman aşımına uğradı.",
"PRM_CannotRegisterTwice":"PageRequestManager birden çok kez başlatılamaz.",
"PRM_UnknownToken":"Bilinmeyen belirteç: \u0027{0}\u0027.",
"PRM_MissingPanel":"ID değeri \u0027{0}\u0027 olan UpdatePanel bulunamadı. Dinamik olarak güncelleştiriliyorsa, başka bir UpdatePanel\u0027ın içinde olmalıdır.",
"PRM_ServerError":"Sunucuda istek işlenirken bilinmeyen bir hata oluştu. Sunucudan döndürülen durum kodu: {0}",
"PRM_ParserError":"Sunucudan alınan ileti ayrıştırılamadı. Bu hatanın sık karşılaşılan nedenleri, yanıtın Response.Write() çağrılarıyla değiştirildiğinde, yanıt filtreleri, HttpModules veya sunucu izinin etkinleştirilmesidir.\r\nAyrıntılar: {0}",
"PRM_TimeoutError":"Sunucu isteği zaman aşımına uğradı.",
"PRM_ParserErrorDetails":"\u0027{0}\u0027 yakınında ayrıştırma hatası.",
"PRM_CannotRegisterTwice":"PageRequestManager birden çok kez başlatılamaz."
};
